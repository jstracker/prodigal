...
class Chest:
    def __init__(self, chest_type, structure_config, item_config, background='brick_wall_small'):
        ...
        self.screen_image = self.structure['chests'][chest_type]['screen_image']
        self.map_image = self.structure['chests'][chest_type]['map_image']
    ...
    def update_image(self):
        if not self.items:
            self.map_image = self.structure['chests'][self.type]['image_empty']
        elif not self.locked:
            self.map_image = self.structure['chests'][self.type]['image_open']
        else:
            self.map_image = self.structure['chests'][self.type]['map_image']
